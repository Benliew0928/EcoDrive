...
const styleSheet = `
  ...
  .rewards-page-shell{box-sizing:border-box;height:100dvh;min-height:0;overflow:hidden;padding:68px 18px 76px}.marketplace-frame{box-sizing:border-box;display:flex;flex-direction:column;height:100%;padding:12px}.marketplace-hero{flex:0 0 auto;gap:14px;grid-template-columns:minmax(0,1fr) minmax(300px,350px);padding:12px 16px}.marketplace-eyebrow{font-size:9px}.marketplace-hero h1{font-size:clamp(24px,2.8vw,36px);margin-top:4px}.marketplace-hero-copy>p:last-child{font-size:10px;line-height:1.4;margin-top:5px}.marketplace-balance{display:grid;gap:3px;grid-template-columns:minmax(0,1fr) auto;padding:10px 12px}.balance-label,.marketplace-balance>strong,.balance-earned{grid-column:1}.marketplace-balance>strong{font-size:35px;margin-top:0}.balance-earned{font-size:9px;margin-top:0}.balance-expiry{grid-column:2;grid-row:1/4;margin:0;min-width:175px;padding:8px}.marketplace-category-row{flex:0 0 auto;margin:8px 0 6px}.marketplace-categories{gap:6px;padding-bottom:3px}.category-pill{font-size:9px;padding:7px 12px}.my-rewards-button{padding:6px 10px}.marketplace-tools{flex:0 0 auto;gap:7px;margin-bottom:7px;padding:6px}.marketplace-search,.marketplace-sort{gap:2px}.marketplace-search input,.marketplace-sort select{height:32px}.marketplace-section-heading{align-items:center;flex:0 0 auto;margin:0 1px 6px}.marketplace-section-heading div{display:flex;gap:8px}.marketplace-section-heading h2{font-size:16px}.marketplace-section-heading>small{font-size:9px}.marketplace-grid{align-content:start;flex:1;gap:9px;grid-auto-rows:max-content;min-height:0;overflow-y:auto;padding:1px 4px 8px 1px;scrollbar-color:rgba(55,229,143,.38) transparent;scrollbar-width:thin}.marketplace-card{border-radius:12px}.marketplace-card:hover,.marketplace-card:focus-within{transform:translateY(-2px)}.marketplace-image-button{height:88px}.marketplace-badge{font-size:7px;left:7px;padding:4px 6px;top:7px}.marketplace-card-body{padding:9px}.marketplace-title-group{gap:2px}.marketplace-title-group h3{font-size:12px}.marketplace-title-group span{font-size:8px}.marketplace-card-body>p{display:-webkit-box;font-size:9px;line-height:1.35;margin:5px 0 7px;min-height:24px;overflow:hidden;-webkit-box-orient:vertical;-webkit-line-clamp:2}.yield-coin{font-size:8px;height:18px;width:18px}.marketplace-price strong{font-size:20px}.marketplace-price small{font-size:8px}.marketplace-meta{gap:3px;margin-top:6px;padding-top:6px}.marketplace-meta>span:first-child,.marketplace-expiry{font-size:8px}.marketplace-redeem{height:31px;margin-top:7px}.marketplace-empty{margin-top:4px;padding:22px 15px}
  .balance-expiry{box-sizing:border-box;gap:6px;min-width:0;padding:6px;width:142px}.balance-expiry .expiry-alert{font-size:8px;height:18px;width:18px}.balance-expiry small{font-size:7px}.balance-expiry b{font-size:8px;line-height:1.15;white-space:normal}
  @media (max-width: 1199px) { .marketplace-hero{grid-template-columns:minmax(0,1fr) minmax(270px,320px)}.marketplace-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.marketplace-image-button{height:105px} }
  @media (max-width: 640px) { .rewards-page-shell{padding:60px 7px 70px}.marketplace-frame{border-radius:12px;padding:7px}.marketplace-hero{border-radius:11px;gap:6px;grid-template-columns:1fr;padding:8px 10px}.marketplace-hero-copy>p:last-child{display:none}.marketplace-hero h1{font-size:20px}.marketplace-balance{grid-template-columns:minmax(0,1fr) auto;padding:7px 9px}.marketplace-balance>strong{font-size:27px}.balance-expiry{min-width:150px;padding:5px}.balance-expiry b{font-size:9px}.marketplace-category-row{gap:6px;margin:5px 0}.marketplace-categories{margin:0;order:1;padding:1px 0 3px}.my-rewards-button{font-size:9px;order:2}.marketplace-tools{gap:5px;grid-template-columns:minmax(0,1fr) 116px;margin-bottom:5px;padding:4px}.marketplace-search>span,.marketplace-sort>span{display:none}.marketplace-search input,.marketplace-sort select{height:29px;padding:0 8px}.marketplace-section-heading{margin-bottom:4px}.marketplace-section-heading h2{font-size:14px}.marketplace-section-heading>small{display:none}.marketplace-grid{grid-template-columns:1fr}.marketplace-image-button{height:82px}.marketplace-card{display:grid;grid-template-columns:106px minmax(0,1fr)}.marketplace-image-button{height:100%;min-height:142px}.marketplace-card-body{padding:8px}.marketplace-card-body>p{margin:4px 0 5px}.marketplace-meta{grid-template-columns:1fr 1fr}.marketplace-redeem{height:28px}.reward-detail-modal{display:block;max-height:92vh;overflow-y:auto}.reward-detail-image{height:220px;min-height:0}.reward-detail-content{max-height:none;padding:20px 16px}.reward-detail-content h2{font-size:25px}.reward-detail-facts{grid-template-columns:1fr}.my-rewards-panel{padding:18px} }
`;
